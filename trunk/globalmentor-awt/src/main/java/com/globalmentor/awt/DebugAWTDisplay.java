...
public class DebugAWTDisplay implements DebugDisplay {
	...
	/**
	 * Sets whether displaying of debug information should be enabled. The first time this displayer is enabled (that is, <code>newEnabled</code> is set to
	 * <code>true</code>), the appropriate window will be created for displaying information. When <code>newEnabled</code> is set to <code>false</code>, that
	 * window is destroyed.
