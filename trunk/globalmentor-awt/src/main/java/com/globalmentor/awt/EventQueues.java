...
public class EventQueues {
	...
	/**
	 * Causes the object to have its <code>run()</code> method called in the dispatch thread of the EventQueue. This will happen after all pending events are
	 * processed. The call blocks until this has happened.
	 * <p>
