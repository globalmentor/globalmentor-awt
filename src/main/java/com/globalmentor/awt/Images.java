...
public class Images {
	...
	protected static final Component MEDIA_TRACKER_COMPONENT = new Component() {
		private static final long serialVersionUID = 1L;
	};

	/** The media tracker used to load images. */
	protected static final MediaTracker mediaTracker = new MediaTracker(MEDIA_TRACKER_COMPONENT);
	...
	/**
	 * Uses a <code>MediaTracker</code> to wait until an image is loaded. Returns the status of the loading.
	 * @param image The image to load.
	 * @return The status of the image loading, as defined by <code>MediaTracker</code>, bitwise <strong>OR</strong>ed together: <code>LOADING</code>,
	 *         <code>ABORTED</code>, <code>ERRORED</code>, and/or <code>COMPLETE</code>, or zero if the image hasn't started loading (which should never happen).
	 */
