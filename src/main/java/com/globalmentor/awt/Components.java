...
public class Components {
	 ...
	 * @return The ancestor frame, or <code>null</code> if there is no ancestor frame.
	 */
	public static Frame getParentFrame(final Component component) {
		...
		while(frameComponent != null && !(frameComponent instanceof Frame))
			//keep looking for a frame until we've ran out of components
	 ...
	 * @return The ancestor window, or <code>null</code> if there is no ancestor window.
	 */
	public static Window getParentWindow(final Component component) {
		...
		while(windowComponent != null && !(windowComponent instanceof Window))
			//keep looking for a window until we've ran out of components
